...
class ConnectionsConnectionConnectionidMatchInclude_PathLabelImpl:
    ...
    def delete(cls, connectionId):
        ...
        if connectionId in be.connections.connection:
            del be.connections.connection[connectionId].match.includePath.label
        else:
    ...
    def get(cls, connectionId):
        print 'handling get'
        if connectionId in be.connections.connection:
            return be.connections.connection[connectionId].match.includePath.label
        else:
            raise KeyError('connectionId')
